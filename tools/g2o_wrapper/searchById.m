...
% Find in a Struct-Array the elements whose id
% is 'id'. Return the desired structure
%
% This function works for landmarks and poses
%
function out = searchById(vector, id)
index = find([vector.id] == id);
if(index)
  out = vector(index);
else
  out = -1;
